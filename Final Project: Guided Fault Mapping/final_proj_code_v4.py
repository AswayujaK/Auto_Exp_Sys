...
class OffbPosCtl:
    ...
    isReadyToFly = False
    # location
    orientation = quaternion_from_euler(0, 0, ((5*3.14) / 3))
    orientation2 = quaternion_from_euler(0, 0, ((7 * 3.14) / 12))
    z = 30
    # matrix containing waypoints:
    # four set points: locations =[x, y, z, next four #s represent yaw (as a quaternion)]
    locations = numpy.matrix([[15.667686462402344, 83.42528533935547, z, orientation2[0], orientation2[1], orientation2[2], orientation2[3]],
                              [17.667686462402344, 81.42528533935547, z, orientation[0], orientation[1], orientation[2], orientation[3]],
                              #[36.667686462402344, 17.42528533935547, z, orientation[0], orientation[1], orientation[2], orientation[3]],
                              [60.667686462402344, -67.57471466064453, z, orientation[0], orientation[1], orientation[2], orientation[3]]
                              ])
